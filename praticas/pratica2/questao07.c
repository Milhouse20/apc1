...
int main() {
  ...
  printf("----------------------------\n");
  printf("Salario Bruto...: R$ \x1b[34m%10.2f\x1b[0m\n", valor_salario_bruto);
  printf("Imposto Renda...: R$ \x1b[31m%10.2f\x1b[0m\n", valor_imposto_renda);
  printf("Imposto Previ...: R$ \x1b[31m%10.2f\x1b[0m\n", valor_imposto_previdencia);
  printf("Salario Liquido.: R$ \x1b[34m%10.2f\x1b[0m\n", valor_salario_liquido);
